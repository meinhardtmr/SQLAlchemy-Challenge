...
#### Notes on app.py
  ...
  - The usage for /api/v1.0/\<start>/\<end> requires a start date and and end date with a date format of yyyy-mm-dd. Ex: localhost:5000/api/v1.0/start%20date/end%20date?start_date=2013-03-13&end_date=2014-12-23
